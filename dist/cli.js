  ...
  const reRun = debounce(() => {
    ...
    runProcess.on("message", (data) => {
      if (isDependencyPath(data)) {
        ...
        if (require$$0$2.isAbsolute(dependencyPath) && !micromatch.isMatch(dependencyPath, options.ignore)) {
